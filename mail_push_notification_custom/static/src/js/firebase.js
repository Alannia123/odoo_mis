...
//
            // ✅ Play notification sound (must be user-initiated context or previously interacted tab)
            const audio = new Audio('/mail_push_notification/static/src/sounds/odoo_notification.mp3');
